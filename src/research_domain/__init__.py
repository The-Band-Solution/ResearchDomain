...
_EXPORT_MAP = {
    ...
    "ProfessionalActivityController": ("research_domain.controllers", "ProfessionalActivityController"),
    ...
    "ProfessionalActivity": ("research_domain.domain.entities", "ProfessionalActivity"),
    ...
    "ProfessionalActivityService": ("research_domain.services", "ProfessionalActivityService"),
