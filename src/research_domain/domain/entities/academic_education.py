...
# Association Table for Many-to-Many relationship between AcademicEducation and KnowledgeArea
...
class AcademicEducation(Base, SerializableMixin):
    ...
    researcher = relationship("Researcher", foreign_keys=[researcher_id], back_populates="academic_educations")
